...
<html lang="fr">
  <head>
      ...
      <title>SweatMore | Sweat 4</title>
      <meta name="description" content="Page de l'article Sweat 4">
  </head>
  ...
  ?>
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/sweat/04/front.jpg" class="img-thumbnail" alt="Sweat front">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/sweat/04/back.jpg" class="img-thumbnail" alt="Sweat back">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/sweat/04/mvmt.jpg" class="img-thumbnail" alt="Sweat mouvement">
      </div>
