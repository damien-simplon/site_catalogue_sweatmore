...
<html lang="fr">
  <head>
      ...
      <title>SweatMore | T-Shirt 4</title>
      <meta name="description" content="Page de l'article T-Shirt 4">
  </head>
  ...
  <?php
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/tshirt/04/front.jpg" class="img-thumbnail" alt="T-Shirt front">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/tshirt/04/back.jpg" class="img-thumbnail" alt="T-Shirt back">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/tshirt/04/mvmt.jpg" class="img-thumbnail" alt="T-Shirt mouvement">
      </div>
