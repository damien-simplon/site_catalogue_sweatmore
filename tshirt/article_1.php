  ...
  <body>
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/t-shirt/01/tshirt_front.jpg" class="img-thumbnail" alt="T-Shirt front">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/t-shirt/01/tshirt_back.jpg" class="img-thumbnail" alt="T-Shirt back">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/t-shirt/01/tshirt_mvmt.jpg" class="img-thumbnail" alt="T-Shirt mouvement">
      </div>
