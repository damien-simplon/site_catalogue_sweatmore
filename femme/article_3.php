...
<html lang="fr">
    <head>
        ...
        <title>SweatMore | Femme 3</title>
        <meta name="description" content="Page de l'article Femme 3">
    </head>
    ...
    ?>
        ...
        <div class="produit_image_miniature">
            <img src="../img/produit/femme/03/front.jpg" class="img-thumbnail" alt="Women front">
        </div>

        <div class="produit_image_miniature">
            <img src="../img/produit/femme/03/back.jpg" class="img-thumbnail" alt="Women back">
        </div>

        <div class="produit_image_miniature">
            <img src="../img/produit/femme/03/mvmt.jpg" class="img-thumbnail" alt="Women mouvement">
        </div>
