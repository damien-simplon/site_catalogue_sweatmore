...
<html lang="fr">
    ...
    <body>
        ...
        <div class="produit_image_miniature">
            <img src="../img/produit/women/04/tenue_complete_women_front.jpg" class="img-thumbnail" alt="Women front">
        </div>

        <div class="produit_image_miniature">
            <img src="../img/produit/women/04/tenue_complete_women_back.jpg" class="img-thumbnail" alt="Women back">
        </div>

        <div class="produit_image_miniature">
            <img src="../img/produit/women/04/tenue_complete_women_mvmt.jpg" class="img-thumbnail" alt="Women mouvement">
        </div>
