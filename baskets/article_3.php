  ...
  <?php
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/front.jpg" class="img-thumbnail" alt="Basket côté">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/top.jpg" class="img-thumbnail" alt="Basket dessus">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/mvmt.jpg" class="img-thumbnail" alt="Basket mouvement">
      </div>
