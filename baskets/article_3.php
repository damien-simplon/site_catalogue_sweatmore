  ...
  <body>
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/basket_cote.jpg" class="img-thumbnail" alt="Basket côté">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/basket_dessus.jpg" class="img-thumbnail" alt="Basket dessus">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/baskets/03/basket_mvmt.jpg" class="img-thumbnail" alt="Basket mouvement">
      </div>
