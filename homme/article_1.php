  ...
  <body>
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/men/01/tenue_complete_men_front.jpg" class="img-thumbnail" alt="Homme front">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/men/01/tenue_complete_men_back.jpg" class="img-thumbnail" alt="Homme back">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/men/01/tenue_complete_men_mvmt.jpg" class="img-thumbnail" alt="Homme mouvement">
      </div>
