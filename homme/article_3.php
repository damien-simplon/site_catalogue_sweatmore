  ...
  <?php
    ...
    <div id="produit_image">
      ...
      <div class="produit_image_miniature">
        <img src="../img/produit/men/03/front.jpg" class="img-thumbnail" alt="Homme front">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/men/03/back.jpg" class="img-thumbnail" alt="Homme back">
      </div>

      <div class="produit_image_miniature">
        <img src="../img/produit/men/03/mvmt.jpg" class="img-thumbnail" alt="Homme mouvement">
      </div>
